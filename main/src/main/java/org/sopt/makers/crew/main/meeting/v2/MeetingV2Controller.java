...
public class MeetingV2Controller implements MeetingV2Api {
	...
	public ResponseEntity<MeetingV2ApplyMeetingResponseDto> applyGeneralMeeting(
		...
		return ResponseEntity.status(HttpStatus.CREATED)
			.body(meetingV2Service.applyGeneralMeetingWithAdmissionControl(requestBody, userId));
	}
	...
	public ResponseEntity<MeetingV2ApplyMeetingResponseDto> applyTestGeneralMeeting(
		...
		return ResponseEntity.status(HttpStatus.CREATED)
			.body(meetingV2Service.testApplyGeneralMeetingWithAdmissionControl(requestBody, userId));
	}
	...
	public ResponseEntity<MeetingV2ApplyMeetingResponseDto> applyEventMeeting(
		...
		Integer userId = UserUtil.getUserId(principal);
		return ResponseEntity.status(HttpStatus.CREATED)
			.body(meetingV2Service.applyEventMeetingWithAdmissionControl(requestBody, userId));
	}
