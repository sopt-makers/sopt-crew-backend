...
public interface PostV2Api {
	...
	ResponseEntity<PostV2CreatePostResponseDto> createPost(@Valid @RequestBody PostV2CreatePostBodyDto requestBody,
		Principal principal);
	...
	@ApiResponses(value = {@ApiResponse(responseCode = "200", description = "성공"),})
	ResponseEntity<Void> mentionUserInPost(@Valid @RequestBody PostV2MentionUserInPostRequestDto requestBody,
		Principal principal);
