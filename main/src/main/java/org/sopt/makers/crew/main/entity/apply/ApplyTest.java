...
@Entity
@Getter
@Table(name = "apply_test")
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class ApplyTest extends BaseTimeEntity {
	...
	@Builder
	public ApplyTest(EnApplyType type, Meeting meeting, Integer meetingId, User user, Integer userId,
		String content) {
		this.type = type;
