...
import org.sopt.makers.crew.main.global.interceptor.EventApplyAopSkipInterceptor;
...
public class WebMvcConfig implements WebMvcConfigurer {
	...
	private final EventApplyAopSkipInterceptor eventApplyAopSkipInterceptor;
	...
	public void addInterceptors(InterceptorRegistry registry) {
		registry.addInterceptor(eventApplyAopSkipInterceptor);
	}
}
