...
public class ApplyRepositoryTest {
	...
	void 스터디장이_신청자_리스트_최신순으로_조회() {
		...
		int page = 1;
		int take = 12;
		MeetingGetAppliesQueryDto queryCommand = new MeetingGetAppliesQueryDto(page, take,
			List.of(EnApplyStatus.WAITING, EnApplyStatus.APPROVE, EnApplyStatus.REJECT), "desc");
		Integer meetingId = 1;
		...
		assertThat(applyInfoDto1.getUser())
			...
			.containsExactly(4, "이영지", "profile4.jpg", "010-5555-5555");
		...
		assertThat(applyInfoDto2.getUser())
			.extracting("id", "name", "profileImage", "phone")
			.containsExactly(3, "김철수", "profile3.jpg", "010-3333-4444");
	...
	void 스터디장이_신청자_리스트_오래된순으로_조회() {
		...
		int take = 12;
		MeetingGetAppliesQueryDto queryCommand = new MeetingGetAppliesQueryDto(page, take,
			List.of(EnApplyStatus.WAITING, EnApplyStatus.APPROVE, EnApplyStatus.REJECT), "asc");
		Integer meetingId = 1;
		Integer studyCreatorId = 1;
		Integer userId = 1;
	...
	void 스터디장이_신청자_리스트_대기상태만_오래된순으로_조회() {
		...
		int take = 12;
		MeetingGetAppliesQueryDto queryCommand = new MeetingGetAppliesQueryDto(page, take,
			List.of(EnApplyStatus.WAITING), "asc");
		Integer meetingId = 1;
		Integer studyCreatorId = 1;
		Integer userId = 1;
	...
	void 스터디장이_신청자_리스트_승인상태만_오래된순으로_조회() {
		...
		int take = 12;
		MeetingGetAppliesQueryDto queryCommand = new MeetingGetAppliesQueryDto(page, take,
			List.of(EnApplyStatus.APPROVE), "asc");
		Integer meetingId = 1;
		Integer studyCreatorId = 1;
		Integer userId = 1;
